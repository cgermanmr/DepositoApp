...
{
    public partial class UsuarioControlCambiosForm : Form,IObserverTraducible
    {
        private BindingSource bsUsuarios = new BindingSource();
        public UsuarioControlCambiosForm()
        {
            InitializeComponent();
        }
        ...
        public void ObtenerDatosFiltro()
        {
            ...
            if (cmbEvento.SelectedIndex!=-1)
                _usuarios = _usuarios.FindAll(x => x.TipoModificacion==(TipoModificacion)cmbEvento.SelectedIndex+1);
